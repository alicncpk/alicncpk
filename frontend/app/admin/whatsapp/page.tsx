        ...
        <div className="admin-container">
          ...
          <div className="changelog-panel glass-panel" style={{ marginTop: "2.5rem", textAlign: "left", padding: "2rem" }}>
            ...
            <p style={{ fontSize: "0.9rem", color: "var(--text-secondary)", marginBottom: "2rem" }}>
              This timeline lists the developer updates, B2B CRO copywriting optimizations, and monitoring features implemented across the Ali CNC Private Limited platform.
            </p>
